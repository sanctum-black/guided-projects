...
- [The state of news today](#the-state-of-news-today)
	- [Media Confidence](#1-media-confidence)
	- [Misinformation](#2-misinformation)
	- [The QUIBBLE method](#3-the-quibble-method)
	- [Breaking patterns](#4-breaking-patterns)
		- [Verifying the primary source](#41-verifying-the-primary-source)
		- [Understanding source bias and funding](#42-understanding-source-bias-and-funding)
		- [Analyzing the metrics used](#43-analyzing-the-metrics-used)
		- [Evaluating data collection methods](#44-evaluating-data-collection-methods)
		- [Inspecting Data Visualization Techniques](#45-inspecting-data-visualization-techniques)
		- [Checking for Data Consistency and Timeliness](#46-checking-for-data-consistency-and-timeliness)
		- [Reviewing Statistical Methods](#47-reviewing-statistical-methods)
	- [It happens to everyone, really](#5-it-happens-to-everyone-really)
- [Document structure](#document-structure)
- [A word on metrics](#a-word-on-metrics)
- [Preparing our workspace](#preparing-our-workspace)
	- [Folder structure set up](#1-folder-structure-set-up)
	- [Environment set up](#2-environment-set-up)
		- [R](#21-r)
			- [The R Project](#211-the-r-project)
			- [The R Environment](#212-the-r-environment)
			- [Installing packages](#213-installing-packages)
		- [Python](#22-python)
- [A brief introduction to R for Data Science](#a-brief-introduction-to-r-for-data-science)
	- [What is R?](#1-what-is-r)
	- [Importing modules](#2-importing-modules)
	- [An introduction to functions](#3-an-introduction-to-functions)
	- [Declaring custom functions](#4-declaring-custom-functions)
	- [Reading data](#5-reading-data)
		- [Reading csv files into data.frame objects](#51-reading-csv-files-into-dataframe-objects)
		- [Reading csv files into data.table objects](#52-reading-csv-files-into-datatable-objects)
		- [Reading xlsx files](#53-reading-xlsx-files)
	- [An introduction to dplyr](#6-an-introduction-to-dplyr)
		- [The dplyr verbs](#61-the-dplyr-verbs)
		- [select()](#611-select)
		- [filter()](#612-filter)
		- [mutate()](#613-mutate)
		- [arrange()](#614-arrange)
		- [summarize()](#615-summarize)
	- [Data transformations & dplyr](#7-data-transformations--dplyr)
		- [Transformations using a single verb](#71-transformations-using-a-single-verb)
		- [Transforming using multiple verbs (*the pipe operator*)](#72-transforming-using-multiple-verbs-the-pipe-operator)
		- [Transforming using other functions](#73-transforming-using-other-functions)
		- [Calculating aggregations](#74-calculating-aggregations)
	- [Data tidying & tidyr](#8-data-tidying--tidyr)
		- [Generating tidy data](#81-generating-tidy-data)
		- [Generating untidy data](#82-generating-untidy-data)
	- [Merging objects](#9-merging-objects)
		- [Merging using Base R](#91-merging-using-base-r)
		- [Merging using dplyr](#92-merging-using-dplyr)
		- [Merging using purr](#93-merging-using-purr)
	- [Classical statistics](#10-classical-statistics)
		- [Descriptive statistics](#101-descriptive-statistics)
		- [Probability distributions](#102-probability-distributions)
		- [Correlation and regression analysis](#103-correlation-and-regression-analysis)
	- [Plotting](#11-plotting)
		- [Plotting a simple line chart](#111-plotting-a-simple-line-chart)
		- [Plotting a boxplot](#112-plotting-a-boxplot)
		- [Plotting a jitter plot](#113-plotting-a-jitter-plot)
	- [Building the country hierarchy](#building-the-country-hierarchy)
		- [A word on dimensions & hierarchies](#1-a-word-on-dimensions--hierarchies)
		- [Building our country hierarchy](#2-building-our-country-hierarchy)
